        ...
        case ViewBackground::SIDEBAR:
{
    ...
    NVGcolor sidebarBase = nvgRGB(12, 8, 22);
    NVGcolor sidebarTop  = nvgRGB(28, 14, 46);
    NVGcolor sidebarBot  = nvgRGB(18, 10, 30);

    nvgBeginPath(vg);
    nvgFillColor(vg, a(sidebarBase));
    nvgRect(vg, this->x, this->y + backdropHeight, this->width, this->height - backdropHeight * 2);
    nvgFill(vg);

    NVGpaint topGradient = nvgLinearGradient(
        vg,
        this->x, this->y + backdropHeight,
        this->x, this->y,
        a(sidebarBase),
        a(sidebarTop));
    nvgBeginPath(vg);
    ...
    NVGpaint bottomGradient = nvgLinearGradient(
        vg,
        this->x, this->y + this->height - backdropHeight,
