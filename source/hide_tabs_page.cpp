...
HideTabsPage::HideTabsPage() : AppletFrame(true, true)
{
    ...
    ports = new brls::ToggleListItem("menus/main/ports"_i18n, util::getBoolValue(hideStatus, "ports"));
    list->addView(ports);

    forwarders = new brls::ToggleListItem("menus/main/forwarders"_i18n, util::getBoolValue(hideStatus, "forwarders"));
    list->addView(forwarders);
    ...
    outdatedTitles = new brls::ToggleListItem("menus/tools/outdated_titles"_i18n, true);
    ...
    mtpinstaller = new brls::ToggleListItem("menus/tools/mtp_installer"_i18n, util::getBoolValue(hideStatus, "mtpinstaller"));
    list->addView(mtpinstaller);
    ...
    list->registerAction("menus/cheats/exclude_titles_save"_i18n, brls::Key::B, [this] {
        ...
        updatedStatus["ports"] = ports->getToggleState();
        updatedStatus["forwarders"] = forwarders->getToggleState();
        ...
        updatedStatus["mtpinstaller"] = mtpinstaller->getToggleState();
